...
const AirMilesGrid = Grid__default["default"];
...
const ListCard = ({ data }) => {
    ...
    return (jsxRuntime.jsx(AirMilesGrid, Object.assign({ container: true, justifyContent: "space-between", spacing: 4.5 }, { children: data.map((card) => (jsxRuntime.jsx(AirMilesGrid, Object.assign({ item: true, xs: 12, sm: sizeValue }, { children: jsxRuntime.jsx(AirMilesMediaCard, { image: card.image, imageAlt: card.imageAlt, content: card.content, link: card.link, linkText: card.linkText, id: card.id }) }), card.id))) })));
};
